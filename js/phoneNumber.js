const testPhoneNumber = /^\+[0-9XI*]{1}\([0-9XI*]{3}\)[0-9XI*]{3}-[0-9XI*]{2}-[0-9XI*]{2}/;
const symbolsPhoneNubmer = '+()-';

export default function createPhoneNumber(mask = '') {
    if (testPhoneNumber.test(mask) !== true)
        return;
    ...
    for (const char of mask) {
        if (symbolsPhoneNubmer.indexOf(char) !== -1) {
